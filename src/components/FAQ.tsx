    ...
    <section className="py-20 lg:py-32">
      <div className="container mx-auto px-4">
        <div className="max-w-12xl mx-auto">
          <div className="glass-card animate-slide-up w-[100%] mx-auto">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center pt-8 sm:pt-12 md:pt-[3rem] pb-8 sm:pb-12 md:pb-[10%]">
              <span className="text-white font-bold">Часто задаваемые вопросы</span>
            </h2>
            <Accordion type="single" collapsible className="w-full [&>div:last-child]:border-b-0">
              {faqs.map((faq, index) => (
                <AccordionItem key={index} value={`item-${index}`} className="border-b border-white pb-6 sm:pb-8 md:pb-[2.2rem] hover:bg-white/20 transition-colors duration-800">
                  <AccordionTrigger className="text-left font-semibold text-xl sm:text-2xl pl-4 sm:pl-8 hover:no-underline">
                    {faq.question}
                  </AccordionTrigger>
                  <AccordionContent className="text-foreground/80 text-sm sm:text-base">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
